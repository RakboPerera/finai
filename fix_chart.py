"""Fixes the Chart component echarts import. Run from IAP folder."""
import os
...
p = os.path.join(BASE, "frontend", "components", "charts", "Chart.tsx")
with open(p, "w", encoding="utf-8") as f:
    f.write(chart_code)
print(f"[OK] Fixed {p}")
print("Refresh your browser to see charts render.")
